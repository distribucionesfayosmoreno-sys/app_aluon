...
- **Display & Headlines (Nexa):** This font provides a "machined" feel. Use `display-lg` (3.5rem) with tight letter-spacing (-0.02em) for hero sections to create a bold, monolithic presence.
